...
(function() {
  ...
  // an uncaught TypeError alarm (jsr.fa.contacts is undefined there).
  function bridgeAvailable() {
    return typeof jsr !== 'undefined' && jsr.fa && jsr.fa.contacts;
  }
      ...
      child: {
        ...
        children: [
          { type: 'container', padding: [16, 16, 16, 16],
            ...
            { type: 'icon', name: 'person', color: '#94a3b8', size: 28 } },
          { type: 'sizedBox', height: 12 },
          ...
          { type: 'sizedBox', height: 4 },
          { type: 'text',
            data: 'Device contacts is not available in the web preview.',
